                      ...
                      <form onSubmit={(e) => { this.handleWorkshopSubmit(e, 'DRAFT') }} id="o-form" className="mr-0">
                            ...
                            <div className="form-row">
                                <div className="form-group col-sm-3">
                                    <input defaultValue={this.state.workshop.startDate} name="startDate" type="date" className="form-control o-input-theme o-input-modify-size px-4" id="inputEmail4"
                                ...
                                /></div>*/}
                                <div className="form-group col-sm-3 contactInput">
                                    <input defaultValue={this.state.workshop.endDate} name="endDate" type="date" className="form-control o-input-theme o-input-modify-size px-4" id="inputPassword4" placeholder="End date" />
                                </div>
                                <div className="form-group col-sm-3 contactInput">
                                    <input defaultValue={this.state.workshop.time} name="time" max="12" min="1" type="number" className="form-control o-input-theme o-input-modify-size px-2" id="inputPassword4" placeholder="Time" />
                                </div>
                                <div className="form-group col-sm-3  contactInput o-input-theme o-input-modify-size">
                                    <select defaultValue={this.state.workshop.morningOrEvening} name="morningOrEvening" className="form-control px-4" id="sel1">
                                        <option>PM</option>
                                        <option>AM</option>
                            ...
                            <div className="form-row">
                                ...
                                <div className="form-group col-md-2 pt-2">{`${this.state.progress || 0}%`}</div>
