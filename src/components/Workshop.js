                    ...
                    <div className="container">
                        <div className="workshop-post pt-3 mb-3 ">
                            <div className="d-flex justify-content-between">
                                ...
                                <div className="setDate">{startDate || <Skeleton width={100} duration={0.6} />}&nbsp;-{endDate || <Skeleton width={100} duration={0.6} />} &nbsp;{time || <Skeleton width={100} duration={0.6} />}</div>
                            ...
                            <h3 onClick={viewWorkshop} className="workshop-title my-2">{title || <Skeleton width={100} duration={0.6} />}</h3>
                            <h4 onClick={viewApplicants} className="application-status text-success">{applications || <Skeleton width={100} duration={0.6} />}</h4>
                            <small>{createdAt||<Skeleton width={100} duration={0.6} />}</small>
                        </div>
                    </div>
                </div>
            </div>
